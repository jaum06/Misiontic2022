package com.zlasher.helloworld.list
...
import com.zlasher.helloworld.model.Superheroe
...
class ListSuperheroesActivity : AppCompatActivity() {
    ...
    private fun loadMockSuperHeroesFromJson(): ArrayList<SuperheroeItem> {
        val superHeroeString: String =
            applicationContext.assets.open("superheroes.json").bufferedReader()
                .use { it.readText() }
        val gson = Gson()
        val superHeroesList = gson.fromJson(superHeroeString, Superheroe::class.java)
